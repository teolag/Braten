...
<fieldset id="ego">
	...
	<form action="scripts/updateValues.php?type=ego" method="post" class="jUpdate">
		<ul>
...
<fieldset id="notifications">
	...
	<form action="scripts/updateValues.php?type=notifications" method="post" class="jUpdate">
		<ul>
...
<fieldset id="changePass">
	...
	<form action="scripts/updateValues.php?type=password" method="post" class="jUpdate">
		<ul>
