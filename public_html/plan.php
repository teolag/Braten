...
?>
		...
		<a href="?year=<?php echo $year+1; ?>">Nästa år</a><br />
		<a href="?year=<?php echo $year-1; ?>">Föregående år</a><br />
		<?php if($year!=date("Y")) echo "<a href='plan.php'>Tillbaka till ". date("Y") . "</a>";?><br />
