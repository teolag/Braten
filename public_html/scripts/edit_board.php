...
elseif(empty($_POST['id'])) {
	...
	foreach($notifyUsers as $u) {
		...
		try {
			$message = "Hej ".$u['firstName']."!<br /><br />Ett nytt inlägg har skrivits på planket.<br /><a href='http://braten.nu/board.php'>Klicka här för att undersöka saken</a><br /><br />//Bråten";	
			$mail->CharSet='utf-8';
